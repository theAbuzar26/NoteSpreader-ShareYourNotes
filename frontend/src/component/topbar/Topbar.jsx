    ...
    <>
      <div className="topbar">
        <div className="topbar-left">
          ...
          <Link
            ...
            className="topbar-right-Img-left-link"
          >
            <img
              src={
              ...
              className="topbar-right-Img-left"
      ...
      <div className="menu" ref={menu} style={{ height: "100vh" }}>
        <div className="profile">
          ...
          <div className="menu-desc">
            ...
            <div>
              <Link
                to={user ? `/profile/${user._id}` : `/`}
                style={{ textDecoration: "none", color: "#3E8DE3" }}
              >
                <p className="menu-view-profile" onClick={MenuClickHandler}>
                  View Profile
                </p>
              </Link>
            </div>
        ...
        <Link
          to={`/profile/update`}
          style={{ textDecoration: "none", color: "#3E8DE3" }}
          className="profile-update-menu"
          onClick={MenuClickHandler}
        >
          <p className="profile-update-link-tag">Setting</p>
          <img
            src="https://img.icons8.com/ios/30/000000/settings--v2.png"
        ...
        >
          ...
          <img
            src="https://img.icons8.com/external-sbts2018-blue-sbts2018/38/000000/external-logout-social-media-basic-1-sbts2018-blue-sbts2018.png"
            className="topbar-setting"
          />
        </div>
      </div>
